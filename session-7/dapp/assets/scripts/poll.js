...
((pollingController) => {
 console.log(icon)
    ...
    pollingController.init = () => {
        ...
        worldcupPollContract = web3.eth.contract(contractABI).at(scoreAddress);
        //worldcupPollContract = new web3.eth.Contract(contractABI, scoreAddress);
    ...
    pollingController.poll = (e) => {
        ...
        pollingController.getBalance()
            ...
            .then(myPoll => {
                ...
                if (!myPoll)
                    worldcupPollContract.doVote.sendTransaction(Boolean(+polledValue), {gasPrice: 41000000000}, (err, response) => {
                        if (!err) {
